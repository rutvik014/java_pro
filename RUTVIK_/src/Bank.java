...
public class Bank {
    public static void main(String[] args) {
        ...
        BankAccount account1 = new BankAccount("Virat Kohli", "ICICI", 1800000);
        BankAccount account2 = new BankAccount("Rohit Sharma", "HDFC", 450000);
        BankAccount account3 = new BankAccount("M.S. Dhoni", "SBI", 700000);
        ...
        account2.deposit(3100000);
        account2.withdraw(530000);
        account3.deposit(680000);
        account3.withdraw(740000);
